...
public class ChartsAndGraphsNavigationPageBreak extends BaseTest {
	 ...
	 @Test(groups = { TestGroups.SMOKE, TestGroups.REGRESSION }, testName = "Navigate to  loan Availability by Manager Page")
	    public void loanAvailabilitybyManagerPageNavigation() {

		ExtentTestManager.getTest().getTest()

          .setName("Navigate to  loan Availability by Manager Page");
		...
		ExtentTestManager.getTest().log(LogStatus.PASS,
				"Successful verified loan Availability by Manager Page");
		

	    }
	 
	 
	 @Test(groups = { TestGroups.SMOKE, TestGroups.REGRESSION }, testName = "Navigate to  loan Availability by Client Page")
	    public void loanAvailabilitybyClientPageNavigation() {

		ExtentTestManager.getTest().getTest()

.setName("Navigate to  loan Availability by Client Page");
		ExtentTestManager.getTest().assignCategory("Module:Charts And Graph page break");
		...
		ExtentTestManager.getTest().log(LogStatus.PASS,
				"Successful verified loan Availability by Client Page");
		

	    }
	 
	 @Test(groups = { TestGroups.SMOKE, TestGroups.REGRESSION }, testName = "Navigate to  top 10 AR Concentrations by Client Page")
	    public void top10ARConcentrationsbyClientPageNavigation() {

		ExtentTestManager.getTest().getTest()

.setName("Navigate to  top 10 AR Concentrations by Client Page");
		ExtentTestManager.getTest().assignCategory("Module:Charts And Graph page break");
		...
		Assert.assertTrue(ChartsGraphsPageNavigation.loanAvailabilitybyClientPageHeader());
		ExtentTestManager.getTest().log(LogStatus.PASS,
				"Successful verified top 10 AR Concentrations by Client Page");
		

	    }
	 
	 @Test(groups = { TestGroups.SMOKE, TestGroups.REGRESSION }, testName = "Navigate to  top 10 AP Concentrations by Client Page")
	    public void top10APConcentrationsbyClientPageNavigation() {

		ExtentTestManager.getTest().getTest()

.setName("Navigate to  top 10 AP Concentrations by Client Page");
		ExtentTestManager.getTest().assignCategory("Module:Charts And Graph page break");
		...
		Assert.assertTrue(ChartsGraphsPageNavigation.loanAvailabilitybyClientPageHeader());
		ExtentTestManager.getTest().log(LogStatus.PASS,
				"Successful verified top 10 AP Concentrations by Client Page");
		

	    }
	 
	 @Test(groups = { TestGroups.SMOKE, TestGroups.REGRESSION }, testName = "Navigate to  AR AP Comparison by Client Page")
	    public void ARAPComparisonbyClientPageNavigation() {

		ExtentTestManager.getTest().getTest()
.setName("Navigate to  AR AP Comparison by Client Page");
		ExtentTestManager.getTest().assignCategory("Module:Charts And Graph page break");
		...
		Assert.assertTrue(ChartsGraphsPageNavigation.loanAvailabilitybyClientPageHeader());
		ExtentTestManager.getTest().log(LogStatus.PASS,
				"Successful verified AR AP Comparison by Client Page");
		

	    }
	 
	 
	 @Test(groups = { TestGroups.SMOKE, TestGroups.REGRESSION }, testName = "Navigate to  BBC Ineligibles by Client Page")
	    public void BBCIneligiblesbyClientPageNavigation() {

		ExtentTestManager.getTest().getTest()

.setName("Navigate to  BBC Ineligibles by Client Page");
		ExtentTestManager.getTest().assignCategory("Module:Charts And Graph page break");
		...
		Assert.assertTrue(ChartsGraphsPageNavigation.loanAvailabilitybyClientPageHeader());
		ExtentTestManager.getTest().log(LogStatus.PASS,
				"Successful verified BBC Ineligibles by Client Page");
		

	    }
	 
	 
	 @Test(groups = { TestGroups.SMOKE, TestGroups.REGRESSION }, testName = "Navigate to  receivable BBC aging by Client Page")
	    public void receivableBBCagingbyClientPageNavigation() {

		ExtentTestManager.getTest().getTest()
.setName("Navigate to  receivable BBC aging by Client Page");
		...
		ExtentTestManager.getTest().log(LogStatus.PASS,
				"Successful verified receivable BBC aging by Client Page");
		

	    }
	 
	 
	 @Test(groups = { TestGroups.SMOKE, TestGroups.REGRESSION }, testName = "Navigate to  receivable Spreads by Year Page")
	    public void receivableSpreadsbyYearPageNavigation() {

		ExtentTestManager.getTest().getTest()
.setName("Navigate to  receivable Spreads by Year Page");
		ExtentTestManager.getTest().assignCategory("Module:Charts And Graph page break");
		...
		ExtentTestManager.getTest().log(LogStatus.PASS,
				"Successful verified receivable Spreads by Year Page");
		

	    }
	 
	 
	 @Test(groups = { TestGroups.SMOKE, TestGroups.REGRESSION }, testName = "Navigate to  payable Spreads by Year Page")
	    public void payableSpreadsbyYearPageNavigation() {

		ExtentTestManager.getTest().getTest()
.setName("Navigate to  payable Spreads by Year Page");
		ExtentTestManager.getTest().assignCategory("Module:Charts And Graph page break");
		...
		ExtentTestManager.getTest().log(LogStatus.PASS,
				"Successful verified payable Spreads by Year Page");
		

	    }
	 
	 
	 @Test(groups = { TestGroups.SMOKE, TestGroups.REGRESSION }, testName = "Navigate to  receivable Aging by Client Page")
	    public void receivableAgingbyClientPageNavigation() {

		ExtentTestManager.getTest().getTest()
.setName("Navigate to  receivable Aging by Client Page");
		ExtentTestManager.getTest().assignCategory("Module:Charts And Graph page break");
		...
		ExtentTestManager.getTest().log(LogStatus.PASS,
				"Successful verified receivable Aging by Client Page");
		

	    }
	 
	 
	 @Test(groups = { TestGroups.SMOKE, TestGroups.REGRESSION }, testName = "Navigate to  BBC Availability by Client Page")
	    public void BBCAvailabilitybyClientPageNavigation() {

		ExtentTestManager.getTest().getTest()

.setName("Navigate to  BBC Availability by Client Page");
		ExtentTestManager.getTest().assignCategory("Module:Charts And Graph page break");
		...
		ExtentTestManager.getTest().log(LogStatus.PASS,
				"Successful verified BBC Availability by Client Page");
	 ...
	 @Test(groups = { TestGroups.SMOKE, TestGroups.REGRESSION }, testName = "Navigate to  AR Stats Dilution on Sales Page")
	    public void ARStatsDilutiononSalesPageNavigation() {

		ExtentTestManager.getTest().getTest()

.setName("Navigate to  AR Stats Dilution on Sales Page");
		ExtentTestManager.getTest().assignCategory("Module:Charts And Graph page break");
		...
		ExtentTestManager.getTest().log(LogStatus.PASS,
				"Successful verified AR Stats Dilution on Sales Page");
