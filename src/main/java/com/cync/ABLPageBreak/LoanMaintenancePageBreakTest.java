...
public class LoanMaintenancePageBreakTest extends BasePage {
	...
	private final By TermLoanCreationHeader_xpath =By.xpath("//span[contains(text(),'Term Loan Creation')]");
	...
	private final By TermLoansHeader_xpath =By.xpath("(//span[contains(text(),'Term Loans')])[2]");
