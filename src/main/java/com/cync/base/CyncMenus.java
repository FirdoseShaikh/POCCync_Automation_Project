...
import com.cync.pages.CreditLineLoansPage;
	...
	private final By FundRequest_xpath=By.xpath("//a[text()='Fund Request']");
	 ...
	 private final By selectClient_xpath = By.id("select2-choose_borrower-container");
	  ...
	  //Credit Line
        ...
        private final By creditLineLoansS_xpath=By.xpath("//a[text()='Credit Line Loans']");
		...
		private final By TermLoanCollateralsHeader_xpath =By.xpath("(//a[contains(text(),'Term Loan Collateral Setup')])[1]");
		...
		private final By CreditLineLoanCollateralSetupHeader_xpath =By.xpath("//a[contains(text(),'Credit Line Collateral Setup')]");
		...
		private final By  ParticipationLoanDetailsHeader_xpath =By.xpath("(//a[contains(text(),'Participation Loan Details')])[1]");
		private final By  ParticipationInquiryHeader_xpath =By.xpath("(//a[contains(text(),'Participation Inquiry')])[1]");
		...
		//    private final By  BBCRecalculationProcessPage_xpath=By.xpath("//a[text()='BBC Recalculation Process']");	
		    ...
		    private final By CreateSkippedBBC_Xpath=By.xpath("//a[contains(text(),'Create Skipped BBC')]");
			  ...
			  private final By MappingListView1_Xpath=By.xpath("(//a[contains(text(),'Mapping List View')])[2]");
	...
	public TemplatesPage openTemplate() { 
	 ...
	 public FundRequestPage openFundRequest() {
	  ...
	  //Credit Line
		 ...
		 public CreditLineLoansPage openCreditLineLoanS() {
			 try {
			     this.MouseOverOnMenu();
			     this.moveToLeftNavigation("Loan Maintenance");
			     WebElement CreditLineLoanWebEelement = new WebDriverWait(driver, 1000)
			      .until(ExpectedConditions.elementToBeClickable(creditLineLoansS_xpath));
			     CreditLineLoanWebEelement.click();
			     
			     return new CreditLineLoansPage(driver);
...
return false;
	 ...
	 public BatchCashPage openFundingStylePage() { 
         ...
         this.moveToLeftNavigation("Client Maintenance");     
         WebElement BatchCashWebEelement = new WebDriverWait(driver, 1000)      
         .until(ExpectedConditions.elementToBeClickable(FundingStylePage_xpath));     
         BatchCashWebEelement.click();     
         Thread.sleep(10000);
         return new BatchCashPage(driver); } 
         catch (Exception ex) {     
...
/*
               	 ...
               	 public DailyCashPostingPage openDailyCashPosting() { 
                        ...
                        this.MouseOverOnMenu();     
                        this.moveToLeftNavigation("Cash Application");     
                        WebElement DailyCashPostingWebEelement = new WebDriverWait(driver, 1000)      
                        .until(ExpectedConditions.elementToBeClickable(DailyCashPostingPage_xpath));     
               	 ...
               	 public DailyCashTransactionReportingPage openDailyCashTransactionReporting() { 
                        ...
                        this.MouseOverOnMenu();     
                        this.moveToLeftNavigation("Cash Application");     
                        WebElement DailyCashTransactionReportingWebEelement = new WebDriverWait(driver, 1000)      
                        .until(ExpectedConditions.elementToBeClickable(DailyCashTransactionReportingPage_xpath));     
